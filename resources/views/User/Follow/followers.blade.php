            ...
            <div style="width: 50%; margin-bottom: 0.5rem;">
                @foreach ($followers as $follower)
                    <div style="padding: 1rem; margin-bottom: 0.5rem; background-color: #313131; border-radius: 0.5rem;">
                        <a href="/user/{{ $follower->beingfollowed->id }}" style="display: flex; align-items: center; justify-content:space-between; width: 100%; color: white;">
                            <img src="{{ $follower->beingfollowed->avatar }}" style="height: 70px;" />
                            <p>
                                {{ $follower->beingfollowed->username }}
                            </p>
                        </a>
                    </div>
                @endforeach
